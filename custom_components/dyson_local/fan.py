...
class DysonFanEntity(DysonEntity, FanEntity):  # type: ignore[misc]
    ...
    def is_on(self) -> bool:  # type: ignore[override]
        ...
        state = self._device.is_on  # type: ignore[attr-defined]
        _LOGGER.debug(
    ...
    @property
    def speed_count(self) -> int:  # type: ignore[override]
        """Return the number of different speeds the fan can be set to."""
        return int_states_in_range(SPEED_RANGE)

    @property
    def percentage(self) -> Optional[int]:  # type: ignore[override]
        """Return the current speed percentage."""
        if self._device.speed is None or self._device.auto_mode:  # type: ignore[attr-defined]
            return None
        if not self._device.is_on:  # type: ignore[attr-defined]
            return 0
        return ranged_value_to_percentage(SPEED_RANGE, int(self._device.speed))  # type: ignore[attr-defined]
    ...
    def set_percentage(self, percentage: int) -> None:
        ...
        self._device.set_speed(dyson_speed)  # type: ignore[attr-defined]
        self._device.disable_auto_mode()  # type: ignore[attr-defined]

    @property
    def preset_mode(self) -> Optional[str]:  # type: ignore[override]
        """Return the current selected preset mode."""
        if self._device.auto_mode:  # type: ignore[attr-defined]
    ...
    def set_preset_mode(self, preset_mode: str) -> None:
        ...
        if preset_mode == PRESET_MODE_AUTO:
            self._device.enable_auto_mode()  # type: ignore[attr-defined]
    ...
    @property
    def oscillating(self):  # type: ignore[override]
        """Return the oscillation state."""
        state = self._device.oscillation  # type: ignore[attr-defined]
        _LOGGER.debug(
    ...
    def turn_on(
        ...
        **kwargs,
        ...
        if oscillation_center is not None:
            ...
            current_low = self._device.oscillation_angle_low  # type: ignore[attr-defined]
            current_high = self._device.oscillation_angle_high  # type: ignore[attr-defined]
    ...
    async def async_turn_on(
        ...
        **kwargs,
        ...
        await self.hass.async_add_executor_job(self._device.turn_on)  # type: ignore[attr-defined]
    ...
    def turn_off(self, **kwargs) -> None:
        ...
        return self._device.turn_off()  # type: ignore[attr-defined]
    ...
    def oscillate(self, oscillating: bool) -> None:
        ...
        current_state = self._device.oscillation  # type: ignore[attr-defined]
        _LOGGER.debug(
        ...
        if oscillating:
            ...
            self._device.enable_oscillation()  # type: ignore[attr-defined]
        else:
            _LOGGER.debug(
                "Calling disable_oscillation() for device %s", self._device.serial
            )
            self._device.disable_oscillation()  # type: ignore[attr-defined]

        # Log result
        new_state = self._device.oscillation  # type: ignore[attr-defined]
    ...
    def set_timer(self, timer: int) -> None:
        """Set sleep timer."""
        if timer == 0:
            self._device.disable_sleep_timer()  # type: ignore[attr-defined]
        else:
            self._device.set_sleep_timer(timer)  # type: ignore[attr-defined]
    ...
    async def async_set_state(self, **kwargs):
        ...
        if "angle_low" in kwargs and "angle_high" in kwargs:
            ...
            await self.hass.async_add_executor_job(self.set_angle, low, high)
...
class DysonPureCoolEntity(DysonFanEntity):
    ...
    def __init__(self, device, name: str):
        ...
        super().__init__(device, name)
        # Override supported features for this device type
        self._attr_supported_features = COMMON_FEATURES | FanEntityFeature.DIRECTION

    @property
    def current_direction(self) -> str:  # type: ignore[override]
        """Return the current airflow direction."""
        if self._device.front_airflow:  # type: ignore[attr-defined]
    ...
    def set_direction(self, direction: str) -> None:
        ...
        if direction == DIRECTION_FORWARD:
            self._device.enable_front_airflow()  # type: ignore[attr-defined]
        elif direction == DIRECTION_REVERSE:
            self._device.disable_front_airflow()  # type: ignore[attr-defined]
        else:
            raise ValueError(f"Invalid direction {direction}")

    @property
    def angle_low(self) -> int:  # type: ignore[override]
        """Return oscillation angle low."""
        return self._device.oscillation_angle_low  # type: ignore[attr-defined]

    @property
    def angle_high(self) -> int:  # type: ignore[override]
        """Return oscillation angle high."""
        return self._device.oscillation_angle_high  # type: ignore[attr-defined]
    ...
    def extra_state_attributes(self) -> Mapping[str, Any]:  # type: ignore[override]
        ...
        if hasattr(self._device, "oscillation_angle_low") and hasattr(
            ...
            low_angle = self._device.oscillation_angle_low  # type: ignore[attr-defined]
            high_angle = self._device.oscillation_angle_high  # type: ignore[attr-defined]
            ...
            if self._device.oscillation:  # type: ignore[attr-defined]
                if angle_range == 45:
    ...
    def set_angle(self, angle_low: int, angle_high: int) -> None:
        ...
        self._device.enable_oscillation(angle_low, angle_high)  # type: ignore[attr-defined]

        # Log result
        new_low = self._device.oscillation_angle_low  # type: ignore[attr-defined]
        new_high = self._device.oscillation_angle_high  # type: ignore[attr-defined]
