...
class DysonFanEntity(DysonEntity, FanEntity):  # type: ignore[misc]
    ...
    def is_on(self) -> bool:
        ...
        state: bool = self._device.is_on  # type: ignore[attr-defined]
        _LOGGER.debug(
    ...
    def oscillating(self) -> bool:
        ...
        state: bool = self._device.oscillation  # type: ignore[attr-defined]
        _LOGGER.debug(
    ...
    async def async_handle_service_call(self, service_name: str, **kwargs: Any) -> None:
...
class DysonPureCoolEntity(DysonFanEntity):
    ...
    def angle_low(self) -> int:
        ...
        angle: int = self._device.oscillation_angle_low  # type: ignore[attr-defined]
        return angle

    @property
    def angle_high(self) -> int:
        """Return oscillation angle high."""
        angle: int = self._device.oscillation_angle_high  # type: ignore[attr-defined]
        return angle
